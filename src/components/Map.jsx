      ...
      <div className="absolute top-4 left-4 z-[1001]">
        ...
        >
          <div className="w-5 h-5 flex flex-col justify-center space-y-1">
            <div className={`h-0.5 bg-gray-600 transition-all duration-200 ${panelVisible ? 'rotate-45 translate-y-1' : ''}`}></div>
            <div className={`h-0.5 bg-gray-600 transition-all duration-200 ${panelVisible ? 'opacity-0' : ''}`}></div>
            <div className={`h-0.5 bg-gray-600 transition-all duration-200 ${panelVisible ? '-rotate-45 -translate-y-1' : ''}`}></div>
          </div>
        </button>
      </div>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 text-sm">{availableAreas.length} areas ready</p>
              </div>
              <button
              ...
              >
                <div className={`transition-transform duration-200 ${panelMinimized ? 'rotate-180' : ''}`}>
          ...
          {!panelMinimized && (
            <div className="max-h-[70vh] overflow-y-auto">
              ...
              <div className="p-4 space-y-2">
                <h4 className="font-semibold text-gray-700 text-sm mb-3">Available Areas</h4>
                ...
                >
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    ></div>
                    <span className="font-medium text-sm">{availableAreas[0].name}</span>
                  </div>
                  <p className="text-xs text-gray-500">{availableAreas[0].description}</p>
                </button>
              ...
              {selectedAreaInfo && (
                <div className="border-t border-gray-200 bg-gray-50 p-4">
                  ...
                  <div className="text-xs text-gray-600 space-y-1">
                    <div><span className="font-medium">Status:</span> {selectedAreaInfo.description}</div>
              ...
              {selectedAreaInfo && Object.keys(allGeoJsonData).length > 0 && (
                <div className="border-t border-gray-200 p-4" style={{ backgroundColor: `${selectedAreaInfo.color}10` }}>
                ...
                if (feature.properties) {
                  const popupContent = `
                    <div>
                      ...
                      ${areaName ? `<p style="margin: 0 0 8px 0; color: #6b7280; font-size: 12px;">${areaName}</p>` : ''}
